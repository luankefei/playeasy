d3 = function() {
  ...
  d3.nest = function() {
    ...
    function map(array, depth) {
      ...
      var i = -1,
        n = array.length,
        key = keys[depth++],
        keyValue, object, valuesByKey = new d3_Map(),
        values, o = {};
      while (++i < n) {
  ...
  d3_selectionPrototype.transition = function() {
    var id = d3_transitionInheritId || ++d3_transitionId,
      subgroups = [],
      subgroup, node, transition = Object.create(d3_transitionInherit);
  ...
  d3.behavior.zoom = function() {
    var translate = [0, 0],
      translate0, scale = 1,
      scale0, scaleExtent = d3_behavior_zoomInfinity,
  ...
  d3.geo.greatArc = function() {
    var source = d3_source,
      ...
      target_, precision = 6 * d3_radians,
      interpolate;
  ...
  d3.geo.path = function() {
    var pointRadius = 4.5,
      projection, context, projectStream, contextStream;
  ...
  function d3_geo_projectionMutator(projectAt) {
    var project, rotate, projectRotate, projectResample = d3_geo_resample(function(x, y) {
      ...
      δφ = 0,
      δγ = 0,
      δx, δy, clip = d3_geo_clipAntimeridian,
      clipAngle = null;
